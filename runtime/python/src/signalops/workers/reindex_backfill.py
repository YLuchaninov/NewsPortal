    ...
    while True:
        if await dependencies.is_cancel_requested(reindex_job_id):
            return {
                ...
                "processedSignalCandidates": processed_signal_candidates,
                "totalSignalCandidates": total_signal_candidates,
                "selectionReplayTargetCount": total_signal_candidates,
                "selectionReplayedCount": processed_signal_candidates,
                "enrichmentTargetCount": enrichment_processed if include_enrichment else 0,
                "enrichmentProcessedCount": enrichment_processed,
