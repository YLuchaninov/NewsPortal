  ...
  assert.deepEqual(
    buildDiscoveryProfileCreateApiPayload(
      {
        ...
        graphExpectedSourceShapes: "editorial_stream\ndocument_repository",
        graphAllowedSourceFamilies: "official_updates\neditorial_publication",
        graphDisfavoredSourceFamilies: "aggregator_directory",
        graphUsefulnessHints: "resource_only_expected",
        graphMaxPerSourceFamily: "2",
        graphMaxPerDomain: "1",
        ...
        recallExpectedSourceShapes: "listing_resource\ndocument_repository",
        recallAllowedSourceFamilies: "procurement_listing\ndocument_repository",
        recallDisfavoredSourceFamilies: "vendor_marketing",
        recallUsefulnessHints: "resource_only_expected",
        recallMaxPerSourceFamily: "3",
        recallMaxPerDomain: "2",
    ...
    ),
    {
      ...
      graphPolicyJson: {
        ...
        expectedSourceShapes: ["editorial_stream", "document_repository"],
        allowedSourceFamilies: ["official_updates", "editorial_publication"],
      ...
      recallPolicyJson: {
        ...
        expectedSourceShapes: ["listing_resource", "document_repository"],
        allowedSourceFamilies: ["procurement_listing", "document_repository"],
        disfavoredSourceFamilies: ["vendor_marketing"],
        usefulnessHints: ["resource_only_expected"],
        diversityCaps: { maxPerSourceFamily: 3, maxPerDomain: 2 },
  ...
  assert.deepEqual(
    ...
    }),
    {
      ...
      recallPolicyJson: {
        ...
        allowedSourceFamilies: ["procurement_listing"],
      },
