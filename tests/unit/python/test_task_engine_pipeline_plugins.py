    ...
    def test_register_builtin_plugins_registers_expected_modules(self) -> None:
        ...
        self.assertEqual(
            modules,
            {
                ...
                "discovery.v3.bootstrap_targets",
                "discovery.v3.expand_existing_source",
                "discovery.v3.refresh_coverage",
                "discovery.v3.run",
                ...
                "discovery.v3.action_decider",
                "discovery.v3.endpoint_scorer",
                "discovery.v3.endpoint_sweep",
                "discovery.v3.source_directory_extract",
                "discovery.v3.url_cluster",
