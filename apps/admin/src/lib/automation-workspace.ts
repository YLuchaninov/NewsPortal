...
export const AUTOMATION_TEMPLATES: AutomationTemplateDescriptor[] = [
  {
    id: "signal_candidate_ingest_pipeline",
    title: "SignalCandidate Ingest Pipeline",
    category: "Content",
    description:
    ...
    taskGraph: [
      { key: "extract", module: "enrichment.signal_candidate_extract", options: {}, label: "Extract" },
      { key: "normalize", module: "signal_candidate.normalize", options: {}, label: "Normalize" },
      { key: "dedup", module: "signal_candidate.dedup", options: {}, label: "Deduplicate" },
      { key: "embed", module: "signal_candidate.embed", options: {}, label: "Embed" },
      { key: "criteria", module: "signal_candidate.match_criteria", options: {}, label: "Criteria" },
      { key: "cluster", module: "signal_candidate.cluster", options: {}, label: "Cluster" },
      { key: "interests", module: "signal_candidate.match_interests", options: {}, label: "Interests" },
      { key: "notify", module: "signal_candidate.notify", options: {}, label: "Notify" },
    ],
  },
  {
    id: "signal_candidate_quality_review",
    title: "SignalCandidate Quality Review",
    category: "Content",
    description:
    ...
    taskGraph: [
      ...
      { key: "embed", module: "signal_candidate.embed", options: {}, label: "Embed" },
      { key: "criteria", module: "signal_candidate.match_criteria", options: {}, label: "Criteria" },
      { key: "llm_review", module: "signal_candidate.llm_review", options: {}, label: "LLM Review" },
      { key: "cluster", module: "signal_candidate.cluster", options: {}, label: "Cluster" },
      { key: "interests", module: "signal_candidate.match_interests", options: {}, label: "Interests" },
      { key: "notify", module: "signal_candidate.notify", options: {}, label: "Notify" },
    ],
