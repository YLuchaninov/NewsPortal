...
const SERVER_INSTRUCTION_LINES = [
  ...
  "Before recommending mutations, choose and report a flowMode from signalops://guide/playbooks/operator-flow-modes: diagnostic, planned_change, expert_override, source_onboarding, scenario_pack_rollout, or cleanup.",
