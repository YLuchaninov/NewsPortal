...
const SERVER_INSTRUCTION_LINES = [
  ...
  "System-interest writes must use canonical MCP fields: candidate_positive_signals, candidate_negative_signals, selection_profile_llm_review_mode, and allowed_content_kinds. Do not send candidateSignals, selectionProfile, llmReviewMode, or allowedContentKinds; those are rejected and are not proof of applied config.",
  ...
  "candidateSignals group.name is a conceptual label and group.cues must be literal observable text fragments. Snake_case/id-like cues are warnings, not evidence diversity.",
