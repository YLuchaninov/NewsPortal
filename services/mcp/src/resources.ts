  ...
  },
  {
    ...
    read: async () => ({
      ...
      sessionFlow: [
        ...
        "To execute indirect/search lanes, call discovery.indirect_targets.channels.plan to materialize bounded API search-channel rows, then pass only reviewed rows through channels.bulk_onboard.plan/apply/verify. ddgs_search is the local research adapter and executes directly inside fetchers; SearXNG/Brave/Tavily/Exa are alternative providers.",
