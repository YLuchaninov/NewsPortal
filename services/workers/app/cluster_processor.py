...
from .vector_registry import (
    fetch_article_features_row as default_fetch_article_features_row,
    fetch_article_vectors as default_fetch_article_vectors,
)
...
class ArticleClusterProcessorDependencies:
...
def build_article_cluster_processor_dependencies(
    *,
    ...
    fetch_article_features_row: Callable[..., Awaitable[dict[str, Any]]]
    | None = default_fetch_article_features_row,
    fetch_article_vectors: Callable[..., Awaitable[dict[str, list[float]]]]
    | None = default_fetch_article_vectors,
    ...
    return ArticleClusterProcessorDependencies(
...
async def process_cluster_with_dependencies(
    job: Any,
    _job_token: str,
    deps: ArticleClusterProcessorDependencies,
) -> dict[str, Any]:
...
async def _select_cluster_candidate(
    ...
    *,
    ...
    article_features: Mapping[str, Any],
...
async def process_cluster(job: Any, job_token: str) -> dict[str, Any]:
    return await process_cluster_with_dependencies(
        job,
        job_token,
        build_article_cluster_processor_dependencies(),
    )
