...
from services.api.app.discovery_vnext import orchestration as _orchestration
from services.api.app.discovery_vnext import providers as _providers
from services.api.app.discovery_vnext import repository as _repository
from services.api.app.discovery_vnext import source_inventory as _source_inventory
from services.api.app.discovery_vnext.models import (
...
from services.workers.app.discovery_vnext_probe import execute_probe_plan
from services.workers.app.task_engine.adapters.source_registrar import PostgresSourceRegistrarAdapter

_PATCH_MODULES = (_orchestration, _providers, _repository, _source_inventory)
...
__all__ = [  # noqa: F822 - wrapper exports are installed dynamically for facade monkeypatch compatibility.
    "DiscoveryVNextRunCreatePayload",
    "DiscoveryVNextRunStartPayload",
    "DiscoveryVNextBriefPreviewPayload",
    "DiscoveryVNextArtifactValidatePayload",
