...
export type AdminChannelSchemaProviderType = (typeof ADMIN_CHANNEL_PROVIDER_TYPES)[number];
...
export const ADMIN_CHANNEL_PAYLOAD_SCHEMAS = {
  ...
  api: {
    ...
    properties: {
      ...
      titleField: FLEXIBLE_STRING_SCHEMA,
      leadField: FLEXIBLE_STRING_SCHEMA,
      bodyField: FLEXIBLE_STRING_SCHEMA,
      urlField: FLEXIBLE_STRING_SCHEMA,
      publishedAtField: FLEXIBLE_STRING_SCHEMA,
      externalIdField: FLEXIBLE_STRING_SCHEMA,
      languageField: FLEXIBLE_STRING_SCHEMA,
    },
    additionalProperties: false,
  },
  email_imap: {
