...
const runtimeImages = [
  {
    ...
    maxBytes: 1.2 * gib,
    expectedUser: "node",
    expectedCmd: ["node", "apps/web/dist/server/entry.mjs"],
  },
  {
    image: "docker-admin",
    service: "admin",
    maxBytes: 1.2 * gib,
    expectedUser: "node",
    expectedCmd: ["node", "apps/admin/dist/server/entry.mjs"],
  },
  {
    image: "docker-relay",
    service: "relay",
    maxBytes: 350 * mib,
    expectedUser: "node",
    expectedCmd: ["node", "services/relay/dist/main.mjs"],
  },
  {
  ...
  },
  {
    ...
    maxBytes: 3 * gib,
    expectedUser: "node",
    expectedCmd: ["node", "services/fetchers/dist/main.mjs"],
  ...
  },
  {
    ...
    maxBytes: 350 * mib,
    expectedUser: "node",
    expectedCmd: ["node", "services/mcp/dist/main.mjs"],
  },
  {
    image: "docker-api",
    service: "api",
