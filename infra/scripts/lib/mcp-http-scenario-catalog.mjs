...
export const DETERMINISTIC_SCENARIO_GROUPS = {
  ...
  discovery: ["discovery-operator-flows", "discovery-vnext-full-flow", "read-only-operator-needs"],
};
