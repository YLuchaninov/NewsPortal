...
export function buildInterestPayload(pack, namespace) {
  return {
    ...
    selection_profile_signal_visibility: "explicit_marker",
    selection_profile_auto_select_mode: "evidence_or_llm",
    selection_profile_auto_select_min_positive_groups: 1,
    selection_profile_auto_select_min_cue_hits: 1,
