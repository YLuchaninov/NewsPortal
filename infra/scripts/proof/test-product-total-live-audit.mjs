...
function formatMarkdown(report) {
  const lines = [
    ...
    "## Acceptance Model",
    "",
    "- Discovery vNext total-live acceptance uses required deterministic/runtime/provider/surface lanes.",
    "- Retired legacy proof scripts are outside this audit model.",
