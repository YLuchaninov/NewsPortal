...
values
  ('rss.generic', 'Generic RSS/Atom/JSON Feed', 'Parses ordinary RSS, Atom and JSON Feed sources through the existing fetchers feed parser.', 'builtin', 'rss', 'signal_candidates', 10, '{"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.rss.generic', '{"legacy":{"rssAdapterStrategy":"generic"}}'::jsonb, true, false, 'migration'),
  ('rss.reddit_search_rss', 'Reddit Search RSS', 'Normalizes Reddit search RSS/Atom results while preserving Reddit permalink provenance.', 'builtin', 'rss', 'signal_candidates', 140, '{"urlHostContains":["reddit.com"],"urlPathContains":["search.rss"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.rss.reddit_search_rss', '{"sourceRole":"community_search","legacy":{"rssAdapterStrategy":"reddit_search_rss"}}'::jsonb, true, false, 'migration'),
  ('rss.hn_comments_feed', 'Hacker News Comments Feed', 'Normalizes hnrss.org discussion feeds, drops pure comment updates and preserves discussion provenance.', 'builtin', 'rss', 'signal_candidates', 140, '{"urlHostContains":["hnrss.org"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.rss.hn_comments_feed', '{"sourceRole":"community_search","legacy":{"rssAdapterStrategy":"hn_comments_feed"}}'::jsonb, true, false, 'migration'),
  ('rss.google_news_rss', 'Google News RSS', 'Resolves Google News RSS wrapper URLs to publisher URLs when possible.', 'builtin', 'rss', 'signal_candidates', 150, '{"urlHostContains":["news.google.com"],"urlPathContains":["/rss"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.rss.google_news_rss', '{"sourceRole":"indirect_aggregator","legacy":{"rssAdapterStrategy":"google_news_rss"}}'::jsonb, true, false, 'migration'),
  ('rss.weworkremotely_jobs', 'We Work Remotely RSS', 'Compatibility catalog row for We Work Remotely job-feed ingestion when represented as RSS.', 'builtin', 'rss', 'signal_candidates', 120, '{"urlHostContains":["weworkremotely.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.rss.weworkremotely_jobs', '{"sourceRole":"remote_job_board","legacy":{"apiAdapterKey":"weworkremotely_rss"}}'::jsonb, true, false, 'migration'),
  ...
  ('email_imap.generic_mailbox', 'Generic IMAP Mailbox', 'Polls an IMAP mailbox through the existing email provider and emits signal_candidate drafts.', 'builtin', 'email_imap', 'signal_candidates', 10, '{"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.email_imap.generic_mailbox', '{}'::jsonb, true, false, 'migration'),
  ('api.generic_json_mapping', 'Generic JSON API Mapping', 'Maps JSON endpoint items into signal_candidate drafts using the existing bounded API channel mapping configuration.', 'declarative', 'api', 'signal_candidates', 20, '{"contentType":["application/json"],"allowAutoSelect":false}'::jsonb, '{"type":"object","additionalProperties":true}'::jsonb, '{"runtime":"existing_api_channel_mapping"}'::jsonb, 'declarative.api.generic_json_mapping', '{"legacy":{"genericApiMapping":true}}'::jsonb, true, false, 'migration'),
  ('api.hn_algolia_search', 'HN Algolia Search API', 'Public Hacker News search API adapter.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["hn.algolia.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.hn_algolia_search', '{"sourceRole":"community_search","researchMode":"production","legacy":{"apiAdapterKey":"hn_algolia_search"}}'::jsonb, true, false, 'migration'),
  ('api.github_issues_search', 'GitHub Issues Search API', 'GitHub issue search adapter for implementation blockers, paid feature asks and project signals.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["api.github.com"],"urlPathContains":["/search/issues"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.github_issues_search', '{"sourceRole":"community_search","researchMode":"production","legacy":{"apiAdapterKey":"github_issues_search"}}'::jsonb, true, false, 'migration'),
  ('api.stack_exchange_search', 'Stack Exchange API Search', 'Stack Exchange search adapter for technical questions and implementation signals.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["api.stackexchange.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.stack_exchange_search', '{"sourceRole":"community_search","researchMode":"production","legacy":{"apiAdapterKey":"stack_exchange_search"}}'::jsonb, true, false, 'migration'),
  ('api.ddgs_search', 'DDGS Search', 'Direct DDGS search adapter for bounded research-only acquisition.', 'builtin', 'api', 'signal_candidates', 80, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.ddgs_search', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","risk":{"researchOnly":true,"tosRisk":"unknown"},"legacy":{"apiAdapterKey":"ddgs_search"}}'::jsonb, true, false, 'migration'),
  ('api.searxng_search', 'SearXNG Search', 'SearXNG search adapter for indirect aggregator acquisition.', 'builtin', 'api', 'signal_candidates', 90, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.searxng_search', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","legacy":{"apiAdapterKey":"searxng_search"}}'::jsonb, true, false, 'migration'),
  ('api.brave_search', 'Brave Search API', 'Brave search adapter requiring operator-provided API access.', 'builtin', 'api', 'signal_candidates', 90, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.brave_search', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","risk":{"requiresAuth":true},"legacy":{"apiAdapterKey":"brave_search"}}'::jsonb, true, false, 'migration'),
  ('api.tavily_search', 'Tavily Search API', 'Tavily search adapter requiring operator-provided API access.', 'builtin', 'api', 'signal_candidates', 90, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.tavily_search', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","risk":{"requiresAuth":true},"legacy":{"apiAdapterKey":"tavily_search"}}'::jsonb, true, false, 'migration'),
  ('api.exa_search', 'Exa Search API', 'Exa search adapter requiring operator-provided API access.', 'builtin', 'api', 'signal_candidates', 90, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.exa_search', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","risk":{"requiresAuth":true},"legacy":{"apiAdapterKey":"exa_search"}}'::jsonb, true, false, 'migration'),
  ('api.serpapi_google_news_research', 'SerpAPI Google News Research', 'SerpAPI-powered Google News research adapter.', 'builtin', 'api', 'signal_candidates', 90, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.serpapi_google_news_research', '{"sourceRole":"indirect_aggregator","researchMode":"research_only","risk":{"requiresAuth":true},"legacy":{"apiAdapterKey":"serpapi_google_news_research"}}'::jsonb, true, false, 'migration'),
  ('api.discourse_search', 'Discourse Search', 'Public Discourse search adapter for forum/support community signals.', 'builtin', 'api', 'signal_candidates', 150, '{"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.discourse_search', '{"sourceRole":"forum_support","researchMode":"production","legacy":{"apiAdapterKey":"discourse_search"}}'::jsonb, true, false, 'migration'),
  ('api.greenhouse_job_board', 'Greenhouse Job Board API', 'Public Greenhouse job board API adapter.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["greenhouse.io","boards-api.greenhouse.io"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.greenhouse_job_board', '{"sourceRole":"ats_job_board","researchMode":"production","legacy":{"apiAdapterKey":"greenhouse_job_board"}}'::jsonb, true, false, 'migration'),
  ('api.lever_postings', 'Lever Postings API', 'Public Lever postings API adapter.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["api.lever.co"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.lever_postings', '{"sourceRole":"ats_job_board","researchMode":"production","legacy":{"apiAdapterKey":"lever_postings"}}'::jsonb, true, false, 'migration'),
  ('api.ashby_job_postings', 'Ashby Public Job Posting API', 'Public Ashby job-board API adapter.', 'builtin', 'api', 'signal_candidates', 180, '{"urlHostContains":["api.ashbyhq.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.ashby_job_postings', '{"sourceRole":"ats_job_board","researchMode":"production","legacy":{"apiAdapterKey":"ashby_job_postings"}}'::jsonb, true, false, 'migration'),
  ('api.remotive_jobs', 'Remotive Jobs API', 'Remotive remote jobs API adapter.', 'builtin', 'api', 'signal_candidates', 160, '{"urlHostContains":["remotive.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.remotive_jobs', '{"sourceRole":"remote_job_board","researchMode":"production","legacy":{"apiAdapterKey":"remotive_jobs"}}'::jsonb, true, false, 'migration'),
  ('api.remoteok_jobs', 'RemoteOK Jobs API', 'RemoteOK jobs adapter.', 'builtin', 'api', 'signal_candidates', 160, '{"urlHostContains":["remoteok.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.remoteok_jobs', '{"sourceRole":"remote_job_board","researchMode":"production","legacy":{"apiAdapterKey":"remoteok_jobs"}}'::jsonb, true, false, 'migration'),
  ('api.weworkremotely_rss', 'We Work Remotely RSS Compatibility', 'Compatibility alias for legacy API adapter key representing a We Work Remotely RSS source.', 'builtin', 'api', 'signal_candidates', 100, '{"urlHostContains":["weworkremotely.com"],"allowAutoSelect":true}'::jsonb, '{}'::jsonb, null, 'builtin.api.weworkremotely_rss', '{"sourceRole":"remote_job_board","researchMode":"production","compatibilityAliasFor":"rss.weworkremotely_jobs","legacy":{"apiAdapterKey":"weworkremotely_rss"}}'::jsonb, true, false, 'migration'),
  ('api.peopleperhour_public_projects_research', 'PeoplePerHour Public Projects Research', 'Research-only public project signal adapter.', 'builtin', 'api', 'signal_candidates', 60, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.peopleperhour_public_projects_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true},"legacy":{"apiAdapterKey":"peopleperhour_public_projects_research"}}'::jsonb, true, false, 'migration'),
  ('api.freelancer_public_projects_research', 'Freelancer Public Projects Research', 'Research-only public project signal adapter.', 'builtin', 'api', 'signal_candidates', 60, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.freelancer_public_projects_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true},"legacy":{"apiAdapterKey":"freelancer_public_projects_research"}}'::jsonb, true, false, 'migration'),
  ('api.guru_public_projects_research', 'Guru Public Projects Research', 'Research-only public project signal adapter.', 'builtin', 'api', 'signal_candidates', 60, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.guru_public_projects_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true},"legacy":{"apiAdapterKey":"guru_public_projects_research"}}'::jsonb, true, false, 'migration'),
  ('api.malt_public_projects_research', 'Malt Public Projects Research', 'Research-only public project signal adapter.', 'builtin', 'api', 'signal_candidates', 60, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.malt_public_projects_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true},"legacy":{"apiAdapterKey":"malt_public_projects_research"}}'::jsonb, true, false, 'migration'),
  ('api.contra_public_search_research', 'Contra Public Search Research', 'Research-only public search signal adapter.', 'builtin', 'api', 'signal_candidates', 60, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.contra_public_search_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true},"legacy":{"apiAdapterKey":"contra_public_search_research"}}'::jsonb, true, false, 'migration'),
  ('api.upwork_public_signal_research', 'Upwork Public Signal Research', 'Research-only public signal adapter; not auto-selected by default.', 'builtin', 'api', 'signal_candidates', 50, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.upwork_public_signal_research', '{"sourceRole":"project_marketplace","researchMode":"research_only","risk":{"researchOnly":true,"tosRisk":"high"},"legacy":{"apiAdapterKey":"upwork_public_signal_research"}}'::jsonb, true, false, 'migration'),
  ('api.linkedin_public_signal_research', 'LinkedIn Public Signal Research', 'Research-only public signal adapter; not auto-selected by default.', 'builtin', 'api', 'signal_candidates', 50, '{"allowAutoSelect":false}'::jsonb, '{}'::jsonb, null, 'builtin.api.linkedin_public_signal_research', '{"sourceRole":"closed_professional_network","researchMode":"research_only","risk":{"researchOnly":true,"tosRisk":"high"},"legacy":{"apiAdapterKey":"linkedin_public_signal_research"}}'::jsonb, true, false, 'migration')
