...
select
  ...
  'Recovered placeholder class created by 0042_discovery_core_schema_repair_replay.',
  'active',
  'graph_seed_only',
  '{rss,website}'::text[],
  'Recovered placeholder class created during discovery core schema repair replay.',
  '{}'::jsonb,
  1,
  999,
  jsonb_build_object('repair_migration', '0042_discovery_core_schema_repair_replay')
from (
