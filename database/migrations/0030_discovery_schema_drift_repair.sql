...
select
  ...
  'Recovered placeholder class created by 0030_discovery_schema_drift_repair.',
  'active',
  'graph_seed_only',
  '{rss,website}'::text[],
  'Recovered placeholder class created during schema drift repair.',
  '{}'::jsonb,
  1,
  999,
  jsonb_build_object('repair_migration', '0030_discovery_schema_drift_repair')
from (
