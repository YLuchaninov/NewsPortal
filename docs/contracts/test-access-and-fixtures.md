...
Отслеживай в `.aidp/work.md`, если active work создал или модифицировал:
...
- запиши artifact, cleanup status и rationale в `.aidp/work.md`;
...
Если work touches stateful boundaries, сверяйся не только с `.aidp/verification.md`, но и с этим contract doc.
