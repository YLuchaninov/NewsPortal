# Product Blueprint: NewsPortal

Этот документ является каноническим полным architecture/reference документом для самого продукта NewsPortal.
...
- [`.aidp/blueprint.md`](../../../.aidp/blueprint.md)
