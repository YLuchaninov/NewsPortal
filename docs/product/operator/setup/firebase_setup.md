...
- `.aidp/engineering.md` — для общей engineering discipline;
- `.aidp/contracts/test-access-and-fixtures.md` — для правил по test identities, fixture residue и cleanup, если во время настройки или proof-run создаются persistent локальные артефакты.
