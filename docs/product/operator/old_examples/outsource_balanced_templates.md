...
> **Archive status:** historical example-only companion note. Active outsourcing Example C guidance lives in [EXAMPLES.md](../examples/EXAMPLES.md). Do not apply values from this file over live admin/MCP read-back without recalibration.
